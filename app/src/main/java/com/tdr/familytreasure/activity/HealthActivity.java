    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.text_deal:
                ...
                intent.setClass(HealthActivity.this, PersonConfig.class);
                Bundle bundle = new Bundle();
                bundle.putString("activity", "healthActivity");
                hypertension= TextUtils.isEmpty(hypertension)?"":"," +hypertension;
                diabetes= TextUtils.isEmpty(diabetes)?"":"," +diabetes;
                heartdisease= TextUtils.isEmpty(heartdisease)?"":"," +heartdisease;
