...
import com.tdr.familytreasure.adapter.OlderAlarmAdapter;
import com.tdr.familytreasure.entiy.OlderAlarmInfo;
import com.tdr.familytreasure.entiy.OlderInfo;
import com.tdr.familytreasure.ui.SegmentControlView;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.relative_alarmType:
                if (linear_alarmType.getVisibility() == View.VISIBLE) {
            ...
            case R.id.relative_selectedTime:
                if (linear_selectedTime.getVisibility() == View.VISIBLE) {
                    linear_alarmType.setVisibility(View.GONE);
                    linear_selectedTime.setVisibility(View.GONE);
                    text_alarmType.setTextColor(getResources().getColor(R.color.colorInput));
                    image_alarmType.setBackgroundResource(R.mipmap.image_arrowoff);
            ...
            case R.id.relative_personConfiguration:
                Intent intent1 = new Intent(OlderSelectActivity.this, PersonConfig.class);
