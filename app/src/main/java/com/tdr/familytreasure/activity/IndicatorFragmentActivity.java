...
import com.tdr.familytreasure.ui.TitleIndicator;
...
public abstract class IndicatorFragmentActivity extends FragmentActivity implements ViewPager.OnPageChangeListener {
    private static final String TAG = "BlackDetailsActivity";
    ...
    private final void initView() {
        ...
        image_back.setBackgroundResource(R.drawable.imageclose_change);
        ...
        mPager = (ViewPager) findViewById(R.id.pager_compat);
        mPager.setAdapter(myAdapter);
        mPager.setOnPageChangeListener(this);
        mPager.setOffscreenPageLimit(mTabs.size());

        mIndicator = (TitleIndicator) findViewById(R.id.titleIndicator_choose);
