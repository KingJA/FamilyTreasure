package com.tdr.familytreasure.zbar;
...
public class CaptureActivity extends Activity {
     ...
     */
    private void title() {
        ImageView img_title = (ImageView) findViewById(R.id.fl_menu);
...
//				scanResult.setText("barcode result " + resultStr);
                ...
                if (activity.equals("mainCare")){
                    resultIntent.putExtra("SmartId",SmartId);
